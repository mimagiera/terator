...
public class TeratorExecutorJMetal {
    private static final Logger LOGGER = LoggerFactory.getLogger(TeratorExecutorJMetal.class);
    ...
    public DoubleSolution execute(String osmFile, int concurrentSimulations, int concurrentRoutesGenerator) {
        ...
        return findBestGeneratorVariables.doEverything(city, allBuildingsByType, aggregatedTrafficBySegments,
                concurrentSimulations, concurrentRoutesGenerator);
    }
